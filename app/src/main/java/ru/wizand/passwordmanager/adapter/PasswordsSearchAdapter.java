...
public class PasswordsSearchAdapter extends RecyclerView.Adapter<PasswordsSearchAdapter.MyViewHolder> {
...
//    private ArrayList<Password> passwordArrayList;
    ...
    public PasswordsSearchAdapter(Context context, ArrayList<Password> passwords, MainScreenActivity mainMainScreenActivity) {
        this.context = context;
        this.passwordArrayListSearch = passwords;
    ...
    @NonNull
    @Override
    public PasswordsSearchAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).
                inflate(R.layout.password_list_item,parent,false);
        return new PasswordsSearchAdapter.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull PasswordsSearchAdapter.MyViewHolder holder, int position) {
        final Password password = passwordArrayListSearch.get(position);
...
//        holder.login.setText(password.getLogin());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mainMainScreenActivity.SearchPasswordInBackGround(searchString);
            }
        });
    ...
    public int getItemCount() {
        return  passwordArrayListSearch.size();
    }
